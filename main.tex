...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Divyanshu}{Salve}{ \urlstyle{same}
\href{mailto:dsalve@cs.iitr.ac.in}{dsalve@cs.iitr.ac.in} | \href{mailto:divyanshusalve110@gmail.com}{divyanshusalve110@gmail.com}
}
...
\descript{ Cumulative GPA: 6.485 / 10.0 \\}
...
\subsection{Higher Secondary\\ Education}
\descript{Boards 81.00\%}\\
\location{Grad. May 2016|  Indore, India}
\sectionsep
...
Github:// \href{https://github.com/Divyanshu-Salve}{\bf Divyanshu-Salve} \\
LinkedIn://  \href{https://www.linkedin.com/in/divyanshu-salve-6324b6185/}{\bf divyanshu-salve} \\
...
\location{Confortable}
C \textbullet{} C++ \textbullet{}
Java \textbullet{}   Shell \textbullet{} Python\\

% OCaml \textbullet{} Matlab \textbullet{} Rails \textbullet{} \LaTeX\ \\ 
\location{Familiar}
Java \textbullet{} Javascript \textbullet{} Typescript \textbullet{}  Assembly \\
...
\section{Experience}
\runsubsection{Angular Web Development}
\descript{| Software Developer Remote Intern }
\location{BNY Mellon 2020}
\sectionsep
...
\section{PROJECTS}
\runsubsection{IIT Roorkee}
\descript{| Android Application | Appetizer}
...
\projectDescription{\textbullet{}An Android Application as a utility for college campus Canteens\\
\textbullet{}Android Studio\\
\textbullet{}Firebase as database service}
\sectionsep
